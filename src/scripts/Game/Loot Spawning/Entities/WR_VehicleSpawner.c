class WR_VehicleSpawnerClass: GenericEntityClass
{
}

class WR_VehicleSpawner: GenericEntity
{
	...
	void TryRespawnLoot(int currentTimeMilliseconds)
	{
		...
		WR_LootTable lootTable = WR_VehicleSpawningManagerComponent.Cast( GetGame().GetGameMode().FindComponent(WR_VehicleSpawningManagerComponent) ).allLootTables.Get(LootTableID);
	...
	{
		Print("hello?");
		WR_VehicleSpawningManagerComponent manager = WR_VehicleSpawningManagerComponent.Cast( GetGame().GetGameMode().FindComponent(WR_VehicleSpawningManagerComponent) );
		Print("=================================");
	...
	void WR_VehicleSpawner(IEntitySource src, IEntity parent)
	{
